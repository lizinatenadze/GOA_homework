...
purchase_amount = float(input("შეიყვანეთ შესყიდვის თანხა: "))


if age > 60 or purchase_amount >= 100:
    print("თქვენ შეგიძლიათ მიიღოთ ფასდაკლება.")


    if age > 60:
        print("თქვენი ასაკის მიხედვით ფასდაკლება შე.")


    if purchase_amount >= 100:
        print("თქვენი შესყიდვის მთლიანი თანხა შესაბამისია.")


else:
    print("თქვენ ვერ მიიღებთ ფასდაკლებას.")
